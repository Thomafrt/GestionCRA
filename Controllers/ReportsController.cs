    ...
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Reports != null ? 
                          View(await _context.Reports.Include(r=>r.Entries).ToListAsync()) :
        ...
        public async Task<IActionResult> Create([Bind("Id,BeginWeek,EndWeek")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BeginWeek,EndWeek")] Report report)
        {
            if (id != report.Id)
            {
                return NotFound();
